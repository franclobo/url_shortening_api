...
export const Footer = () => {
  return (
    <footer className="">
      ...
      <div className="bg-gray-800 text-white flex flex-col items-center justify-center text-center py-10">
        <h2 className="text-3xl font-bold mb-5">Shortly</h2>
        <ul className="my-5 flex flex-col items-center justify-center gap-2">
        ...
        <ul className="my-5 flex items-center justify-center gap-6">
